// components/budget/BudgetList.tsx - HYBRID VERSION
...
const BudgetList: React.FC<BudgetListProps> = ({
  ...
  // Use hook for permissions
  const userCanEdit = canEdit !== undefined ? canEdit : canManageBudgets();

  // Direct check for debugging
  const userRole = user?.globalRole || "member";
  const roleLower = userRole.toLowerCase();
  const directCanEdit =
    roleLower === "company_owner" ||
    roleLower === "company_admin" ||
    roleLower === "super_admin";

  console.log("=== BUDGET LIST PERMISSIONS ===");
  console.log("User role:", userRole);
  console.log("canManageBudgets():", canManageBudgets());
  console.log("userCanEdit (from hook/prop):", userCanEdit);
  console.log("directCanEdit:", directCanEdit);
  console.log("canEdit prop:", canEdit);
  ...
  const fetchExpenses = async () => {
    ...
    try {
      const response = await expenseAPI.getExpenses(currentCompany.id);
      if (response.success) {
