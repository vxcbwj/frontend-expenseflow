...
const CompanyUsersPage: React.FC = () => {
  ...
  const { canManageUsers, isAdmin, isSuperAdmin, isCompanyAdmin } =
    usePermissions();
  ...
  const getUserRoleDisplay = useCallback(() => {
    ...
    return "Member";
  }, [isSuperAdmin, isAdmin, isCompanyAdmin]);
  ...
  useEffect(() => {
    if (hasLoggedRef.current || !user || !companyId) return;

    console.log("👥 CompanyUsersPage INITIAL LOAD:", {
      companyId,
      currentUser: user.id,
      currentUserRole: user.globalRole,
      displayRole: getUserRoleDisplay(),
    });

    hasLoggedRef.current = true;
  }, [user, companyId, getUserRoleDisplay]);
  ...
  // Check permissions
  const hasAccess = companyId && (canManageUsers(companyId) || isAdmin());
        ...
        <div className="bg-gradient-to-br from-red-50 to-rose-50 dark:from-red-900/20 dark:to-rose-900/20 border border-red-200 dark:border-red-800 rounded-2xl p-8">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-red-700 dark:text-red-400">
                You don't have permission to manage users in this company.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl p-6 space-y-3">
            ...
            <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
              ...
              <code className="text-xs font-mono text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-800 px-3 py-1.5 rounded-lg">
                {companyId.substring(0, 12)}...
              </code>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <div>
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 mt-1 text-base">
                  ...
                  <span className="font-semibold text-blue-600 dark:text-blue-400">
                    {currentCompany?.name || "this company"}
                  </span>
                </p>
              </div>
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-3 mt-4">
              ...
              <code className="text-xs font-mono text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-gray-800 px-3 py-1 rounded-lg">
                ...
                <p className="text-2xl font-bold text-gray-800 dark:text-white">
                  {
                    users.filter(
                      (u) =>
                        u.companyRole === "admin" || u.companyRole === "owner"
                    ).length
                  }
                </p>
              </div>
