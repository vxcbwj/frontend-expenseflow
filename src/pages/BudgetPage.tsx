...
const BudgetPage: React.FC = () => {
  ...
  console.log("=== HYBRID PERMISSIONS ===");
  console.log("User role:", userRole);
  console.log("canViewBudgets():", canViewBudgets());
  console.log("canManageBudgets():", canManageBudgets());
  console.log("canAccessBudgets (from hook):", canAccessBudgets);
  console.log("canCreateBudgets (from hook):", canCreateBudgets);
  console.log(
    "Direct check - is company_owner:",
    roleLower === "company_owner"
  );
  console.log(
    "Direct check - is company_admin:",
  ...
  const fetchBudgets = useCallback(async () => {
    ...
    try {
      setError(null);
      const response = await budgetAPI.getBudgets(currentCompany.id);
  ...
  // Initial fetch
  useEffect(() => {
    if (currentCompany && canAccessBudgets) {
      setLoading(true);
      fetchBudgets();
    }
  }, [currentCompany, canAccessBudgets, fetchBudgets]);
