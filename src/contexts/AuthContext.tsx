// contexts/AuthContext.tsx - COMPLETELY UPDATED WITH AXIOS CONFIGURATION
import React, {
  createContext,
  useContext,
  useEffect,
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const login = useCallback(async (email: string, password: string) => {
    ...
    try {
      ...
      if (res.success && res.token) {
        ...
        // ✅ CRITICAL: Set axios default header for all future requests
        api.defaults.headers.common["Authorization"] = `Bearer ${res.token}`;

        // Update authentication state
        setIsAuthenticated(true);

        console.log("✅ Login successful, token saved and axios configured");
  ...
  const logout = useCallback(() => {
    ...
    // ✅ CRITICAL: Remove axios header
    delete api.defaults.headers.common["Authorization"];

    console.log("✅ Logout successful, axios header cleared");
